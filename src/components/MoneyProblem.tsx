...
Bitcoin Was Born From This Crisis - In 2008, as the financial system collapsed and banks got bailed out while ordinary people lost their homes, an anonymous creator released Bitcoin - a new form of money that no government or bank could control, inflate, or manipulate. A money system designed to serve people, not politicians or Wall Street.`;
  return <section id="money-problem" className="py-20 px-4 bg-gradient-to-b from-background to-muted/30 relative z-10">
      <div className="container mx-auto relative">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="bg-card/80 backdrop-blur-sm border border-border/50 rounded-2xl p-8 shadow-xl hover:border-primary/30 transition-all duration-300 relative">
            <CopyButton text="What Money Should Be - Money is fundamentally stored energy. Every time you work or take a financial risk, you exchange your time, effort, and focus for a number in your bank account - a representation of the energy you've invested. Money should allow you to store this energy for future use, so you can later exchange it for things that improve your life: a car, a holiday trip, a home, or simply peace of mind. Good money should reliably preserve the value of your work across time." hashtag="#whybitcoin101-money-should-be" />
          ...
          <div className="bg-card/80 backdrop-blur-sm border border-border/50 rounded-2xl p-8 shadow-xl hover:border-primary/30 transition-all duration-300 relative">
            <CopyButton text="Money Is Broken - Governments and central banks can print currency at will, diluting the value of your hard-earned energy and effectively stealing lifetime from you. As a result, people can no longer rely on it as a dependable store of value. Instead, society has been compelled to seek refuge in real estate, stocks, and other assets as vehicles for savings - roles that rightfully belong to money itself. This distortion has created massive problems: skyrocketing housing costs, inflated asset bubbles, and a world where basic necessities like homes have become unaffordable investments rather than places to live." hashtag="#whybitcoin101-money-broken" />
            <h3 className="text-2xl font-bold mb-6 text-foreground">
              Money Is Broken
            </h3>
          ...
          <div className="text-center">
            <div className="inline-block p-8 rounded-2xl bg-gradient-to-r from-bitcoin-orange/10 to-primary/10 border-2 border-bitcoin-orange/20 backdrop-blur-sm shadow-2xl relative">
              <CopyButton text="Bitcoin Was Born From This Crisis - In 2008, as the financial system collapsed and banks got bailed out while ordinary people lost their homes, an anonymous creator released Bitcoin - a new form of money that no government or bank could control, inflate, or manipulate. A money system designed to serve people, not politicians or Wall Street." hashtag="#whybitcoin101-bitcoin-crisis" />
