            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-6 bg-card/60 backdrop-blur-sm border border-border/30 rounded-2xl hover:border-primary/30 transition-all duration-300">
                  ...
                  <span className="text-lg font-medium text-foreground">Hidden edit mode to copy and improve any content on the site</span>
                </div>
                <div className="flex items-start space-x-4 p-6 bg-card/60 backdrop-blur-sm border border-border/30 rounded-2xl hover:border-primary/30 transition-all duration-300">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-lg font-medium text-foreground">Global coordination on permissionless rails</span>
                </div>
              </div>
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-6 bg-card/60 backdrop-blur-sm border border-border/30 rounded-2xl hover:border-primary/30 transition-all duration-300">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-lg font-medium text-foreground">Infinite upscale - one improvement helps everyone</span>
                </div>
                <div className="flex items-start space-x-4 p-6 bg-card/60 backdrop-blur-sm border border-border/30 rounded-2xl hover:border-primary/30 transition-all duration-300">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
