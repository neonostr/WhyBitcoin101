        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-primary/5 to-primary/10 backdrop-blur-sm border border-primary/20 rounded-3xl p-12 shadow-xl">
            <div className="text-center space-y-8">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                    Thanks to permissionless communication technology, we can now work together to create the world's best Bitcoin educational content. A single answer can reach billions of people. This is how we orange pill the world - together.
              </p>
            </div>
          </div>
        </div>
